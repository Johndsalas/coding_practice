...
drop temporary table bayes_828.temp_sakila;

select * from bayes_828.temp_sakila;

create temporary table bayes_828.temp_sakila as
select amount from sakila.payment;
-- Write the SQL necessary to transform the amount column such that it is stored as an integer representing the number of cents of the payment. For example, 1.99 should become 199.

ALTER TABLE bayes_828.temp_sakila
ALTER COLUMN amount INT;

update bayes_828.temp_sakila  -- Out of range value for column 'amount' at row 44
set amount = amount * 100;

create temporary table bayes_828.temp_sakila2 as
select amount * 100 from sakila.payment;

ALTER TABLE bayes_828.temp_sakila2
ALTER COLUMN amount INT;

select * from bayes_828.temp_sakila2;
